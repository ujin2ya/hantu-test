// QVA2 실험 라인 라우터. 기존 라우터는 건드리지 않는다. src/routes/index.js 에서 mount.
...
router.get("/qva2-validation", c.getValidation);

// QVA2 종목 상세 — 기존 /qva-vvi-redefined/:code의 detail 페이지(차트·재무·뉴스·AI)를 재사용한다.
// 기존 controller/EJS는 무수정. 같은 chart cache·KIS·DART·Naver를 그대로 read.
