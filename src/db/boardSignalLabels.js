...
const KIND_WEIGHTS = Object.freeze({
  BREAKOUT_SUCCESS:         18,
  CLOSE_REBREAK_VOL_EXPLOSION: 17,
  CLOSE_REBREAK_HOLD_NEXTDAY:  16,
  CLOSE_REBREAK_NO_BREACH:  15,
  CLOSE_REBREAK:            14,
  CLOSE_REBREAK_BREACH_RECOVER: 12,
  VVI2_FIRED:               16,
  VVI_FIRED:                14,
...
const FILTER_PRESETS = Object.freeze({
  STRONG_REACTION: {
    ...
    includeKind: ['VVI_FIRED', 'VVI2_FIRED', 'BREAKOUT_SUCCESS', 'CLOSE_REBREAK', 'CLOSE_REBREAK_NO_BREACH', 'CLOSE_REBREAK_VOL_EXPLOSION', 'CLOSE_REBREAK_HOLD_NEXTDAY', 'CLOSE_REBREAK_BREACH_RECOVER', 'TODAY_INITIAL_BREAKOUT'],
...
const KIND_DISPLAY = Object.freeze({
  ...
  CLOSE_REBREAK_VOL_EXPLOSION: '재돌파 거래대금 폭발',
  CLOSE_REBREAK_HOLD_NEXTDAY:  '재돌파 다음날 유지',
  CLOSE_REBREAK_BREACH_RECOVER:'재돌파 이탈후 회복',
  STABLE_BREAKOUT:         '안정 돌파',
  STRONG_VALUE:            '강한 거래대금',
  ATTACK_TOP:              '공격형 TOP',
  MAIN:                    '메인 후보',
