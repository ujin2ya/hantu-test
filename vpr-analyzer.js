...
const VPR_DESCRIPTIONS = {
  STRONG_VPR_SUCCESS: '정상 눌림 후 돌파일 고가를 재돌파하고 종가가 유지된 강한 후속 확인 상태입니다.',
  CLASSIC_VPR_SUCCESS: '정상 눌림 후 기준 가격을 다시 회복하고 종가가 유지된 상태입니다.',
  WEAK_VPR_REBOUND: '눌림 후 기준 가격을 장중 재돌파했지만 종가 유지가 약한 상태입니다.',
  PULLBACK_PENDING: '돌파 성공 후 정상 눌림을 만들고 재돌파를 기다리는 상태입니다. 강한 신호 아님.',
  REBOUND_FAIL: '눌림 후 10거래일 안에 재돌파가 나오지 않은 상태입니다.',
  STRUCTURAL_BREAK: '기준 가격을 의미 있게 이탈해 돌파 구조가 약해진 상태입니다.',
  NO_PULLBACK_RUNAWAY: '돌파 성공 후 눌림 없이 상승이 이어진 상태입니다. 신규 진입은 추격 주의입니다.',
